...
export const sendVerificationEmail = async (email, token) => {
  ...
  const logoUrl = "https://res.cloudinary.com/djr7uqara/image/upload/v1757276957/x5jwhjxsbak613duhbn3.png";

  const mailOptions = {
    from: `PureLuxury <${process.env.GOOGLE_EMAIL_USERNAME}>`,
    to: email,
    subject: "Verify Your PureLuxury Account",
    text: `Welcome to PureLuxury! Please verify your email by clicking this link: ${confirmLink}`,
    html: `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          ">
            ...
            <tr>
              <td style="padding: 30px 0; text-align: center; background: linear-gradient(to right, #1e40af, #3b82f6);">
                <img src="${logoUrl}" alt="PureLuxury" style="max-width: 200px; height: auto;">
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 30px 40px;">
                <h1 style="margin: 0 0 20px; color: #2563eb; font-size: 24px;">Welcome to PureLuxury!</h1>
            ...
            <tr>
              ...
              ">
                <p style="margin: 0 0 10px;">
                  <strong style="color: #2563eb;">PureLuxury</strong><br>
                  Your trusted online shopping destination
                </p>
                <p style="margin: 0;">
                  <a href="mailto:PureLuxury27@gmail.com" style="color: #2563eb; text-decoration: none;">PureLuxury27@gmail.com</a>
                </p>
                <p style="margin: 10px 0 0; font-size: 12px;">
                  © ${new Date().getFullYear()} PureLuxury. All rights reserved.
                </p>
              </td>
            </tr>
          </table>
...
export const sendPasswordResetEmail = async (email, token) => {
  ...
  const mailOptions = {
    from: `PureLuxury <${process.env.GOOGLE_EMAIL_USERNAME}>`,
    to: email,
    subject: "Reset Your PureLuxury Password",
          ...
          ">
            ...
            <tr>
              ...
              ">
                ...
                <p style="margin: 0;">
                  <a href="mailto:pureluxury247@gmail.com" style="color: #2563eb; text-decoration: none;">pureluxury247@gmail.com</a>
                </p>
                <p style="margin: 10px 0 0; font-size: 12px;">
                  © ${new Date().getFullYear()} PureLuxury. All rights reserved.
                </p>
            ...
            <tr>
              <td style="padding: 30px 40px; background-color: #ffffff;" class="responsive-padding">
                ...
                <p style="font-size: 14px; color: #777; margin-top: 25px;">
                  ...
                  <a href="mailto:pureluxury247@gmail.com" style="color: #2563eb;">support team</a>.
                </p>
              </td>
            </tr>
...
export const sendNewArrivalsEmail = async (email, name, products) => {
  const baseUrl = getBaseUrl();
  const logoUrl = "https://res.cloudinary.com/djr7uqara/image/upload/v1757276957/x5jwhjxsbak613duhbn3.pngg";
    ...
    html: `
      ...
      <html>
        <head>
          <meta charset="utf-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>New Arrivals at PureLuxury</title>
          <style>
            @media only screen and (max-width: 600px) {
              .responsive-table {
                width: 100% !important;
